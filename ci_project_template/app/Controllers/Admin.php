...
class Admin extends MyController
{
    ...
    public function permission($id)
    {
        ...
        $userModel = new Sitefunction();
        $userModel->protect(false);
        $this->dataModule['permission'] = $userModel->get_all_rows(TBL_CREDENTIAL, '*', array('Id' => $id));
    ...
    public function changeStatus()
    {
        ...
        $log = $requestData->log;
        $edit = $requestData->edit;
        $add = $requestData->add;
        $delete = $requestData->del;
        ...
        $userModel = new Sitefunction();
        $userModel->protect(false);
        $this->dataModule['col'] = $userModel->update_data(TBL_CREDENTIAL, $data_array, array('Id' => $id));
