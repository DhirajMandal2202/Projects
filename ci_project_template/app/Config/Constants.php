...
define('DB_USER', 'root');
define('DB_PASS', 'Mitaoe@123');
define('DB_DATABASE', 'ci4');


//DOMAIN Paths
define('DOMAIN_URL', 'http://localhost/ci_project_template/');
define('SITE_URL', DOMAIN_URL);

//BASE Paths
define('DOMAIN_BASE_URL', $_SERVER['DOCUMENT_ROOT'] . '/ci_project_template/');
...
define("TBL_INFO", TBL_PREFIX . "info");
define("TBL_CREDENTIAL",  TBL_PREFIX . "credential");
define("TBL_LOG", TBL_PREFIX . "log");
define("TBL_COUNTRY", TBL_PREFIX . "country");
define("TBL_STATE", TBL_PREFIX . "state");
define("TBL_CONTROLLER", TBL_PREFIX . "admincontroller");
...
//Add new Paths controller
define('INDEX_PATH', SITE_URL . '');
